...
A = pd.read_csv('C:/Users/Dingge/Downloads/deepLsm/data/eveques_new/ResoEvequesClean2021-A.csv', header=0, sep=';').to_numpy()
labels = np.loadtxt('cl_k=13_p=16.txt').astype(np.int32)
...
# x = np.loadtxt('x.txt')
# y = np.loadtxt('y.txt')
pos = np.loadtxt('pos_k=13_p=16.txt')
pos1 = dict()
for i in range(1287):
...
dict_color = {0:'#7294d4',1:'#fdc765', 2:'#869f82', 3:'lightblue', 4:'lightgreen', 5:'pink', 6:'orange',
              7:'purple', 8:'red', 9:'yellow', 10:'grey', 11:'blue', 12:'green', 13:'darkkhaki', 14:'darksalmon'}
